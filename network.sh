...
function createOrgs() {
  ...
  if [ "$CRYPTO" == "Certificate Authorities" ]; then
    ...
    docker-compose up -d ca_org1 ca_org2 ca_orderer 2>&1
...
function networkUp() {
  ...
  docker-compose up -d orderer.blockchain.sensefinity.com couchdb0 couchdb1 peer0.org1.blockchain.sensefinity.com peer0.org2.blockchain.sensefinity.com 2>&1
...
# chaincode name defaults to "sensefinity"
CC_NAME="sensefinity"
# chaincode path defaults to "./chaincode"
